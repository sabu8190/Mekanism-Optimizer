...
public final class MekanismOptimizerConfig {
    ...
    static {
        ...
        ENABLE_UNLIMITED_AUTO_EJECT = builder
                ...
                .translation("mekanism_optimizer.config.enableUnlimitedAutoEject")
                .define("enableUnlimitedAutoEject", false);
        ...
        AUTO_EJECT_BURST_MULTIPLIER = builder
                ...
                .translation("mekanism_optimizer.config.autoEjectBurstMultiplier")
        ...
        ITEM_EJECT_MAX_STACKS_PER_TICK = builder
                ...
                .translation("mekanism_optimizer.config.itemEjectMaxStacksPerTick")
